...
urlpatterns = [
    ...
    path(
        "<int:pk>/get/", StaffScheduleDetailView.as_view(), name="staff_schedule_detail"
    ),
    path(
        "<int:pk>/delete/",
        StaffScheduleDeleteView.as_view(),
        name="staff_schedule_delete",
    ),
    path(
        "<int:pk>/edit/", StaffScheduleUpdateView.as_view(), name="staff_schedule_edit"
    ),
]
